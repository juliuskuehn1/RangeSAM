...
class SAM2UNet(nn.Module):
    def __init__(self,model_cfg, checkpoint_path=None, stem="rangeformer", freeze_weight=False, adapter=False, msca=False, unify_dim=256) -> None:
        ...
        self.decoder = RSAMDecoder(out_channels=out_channels, unify_dim=unify_dim)
