...
class SAM2UNet(nn.Module):
    def __init__(self, checkpoint_path=None) -> None:
        ...
        old_conv = model.image_encoder.trunk.patch_embed.proj
        new_conv = nn.Conv2d(
            in_channels=5,
        ...
        blocks = nn.ModuleList([
            Adapter(self.encoder.blocks[0]),
            Adapter(self.encoder.blocks[1]),
            Adapter(self.encoder.blocks[2]),
            Adapter(self.encoder.blocks[3]),
            Adapter(self.encoder.blocks[4]),
            Adapter(self.encoder.blocks[5]),
            Adapter(self.encoder.blocks[6]),
            Adapter(self.encoder.blocks[7]),
            Adapter(self.encoder.blocks[8]),
            Adapter(self.encoder.blocks[9]),
            Adapter(self.encoder.blocks[10]),
            Adapter(self.encoder.blocks[11]),
        ])
        self.encoder.blocks = blocks
