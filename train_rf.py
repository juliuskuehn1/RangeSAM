...
def combined_loss(logits, mask, num_classes=20,
                  w_ce=0.25, w_dice=0.25, w_lovasz=0.25, w_boundary=0.25):
    """
...
def initiate_parser():
    ...
    train_data =SemanticKitti(root="data",
    ...
    trainloader = torch.utils.data.DataLoader(train_data,
                                                   ...
                                                   pin_memory=True,
                                                   drop_last=True)
    valid_dataset = SemanticKitti(root="data",
...
def main(args):
    ...
    model = SAM2UNet("sam2.1_hiera_s.yaml" ,args.hiera_path).to(device)
